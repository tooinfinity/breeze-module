...
{
    use InstallsApiStack, InstallsBladeStack, InstallsInertiaStacks, InstallsLivewireStack,InstallsModuleApiStack,InstallsModuleBladeStack;
     ...
     * @var string
     */
    protected $signature = 'breeze:install {stack : The development stack that should be installed (blade,livewire,livewire-functional,react,vue,api,module-blade,module-api)}
    ...
    public function handle()
    {
        ...
        } elseif ($this->argument('stack') === 'module-api') {
            return $this->installModuleApiStack();
        ...
        $this->components->error('Invalid stack. Supported stacks are [blade], [livewire], [livewire-functional], [react], [vue], [module-blade], [module-api], and [api].');
    ...
    protected function afterPromptingForMissingArguments(InputInterface $input, OutputInterface $output)
    {
        ...
        } elseif (in_array($stack, ['blade', 'module-blade', 'livewire', 'livewire-functional'])) {
